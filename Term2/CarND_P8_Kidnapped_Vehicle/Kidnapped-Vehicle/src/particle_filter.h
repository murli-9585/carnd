...
class ParticleFilter {
     ...
     */
    void resample_discreet();

    void resample();

    /* Resamples updated particles based on weights of previous particles.
     */
    void resample_wheel(void);
    /*
    ...
    /**
     * Convert from observed landmark to Map cordinate system wrt to particle.
     */
    LandmarkObs convertToMapCoordinates(const LandmarkObs &obs,
            const Particle &p);
};
