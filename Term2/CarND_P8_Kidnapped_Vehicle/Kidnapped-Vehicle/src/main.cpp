...
int main()
{
        ...
        h.onMessage([&pf,&map,&delta_t,&sensor_range,&sigma_pos,
            &sigma_landmark](uWS::WebSocket<uWS::SERVER> ws,
            char *data, size_t length, uWS::OpCode opCode) {
            // "42" at the start of the message means there's a i
            ...
            double sense_theta = std::stod(j[1]["sense_theta"].
                get<std::string>());
            ...
            double previous_velocity = std::stod(j[1]["previous_velocity"].
                get<std::string>());
            double previous_yawrate = std::stod(j[1]["previous_yawrate"].
                get<std::string>());
            ...
            // sense_observations in JSON format [{obs_x,obs_y},{obs_x,obs_y},
            // ...{obs_x,obs_y}]
